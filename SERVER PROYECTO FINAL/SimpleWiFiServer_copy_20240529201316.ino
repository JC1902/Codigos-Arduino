      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/C-H\">here</a> to turn the LED on pin 5 on.<br>");
            client.print("Click <a href=\"/A-H\">here</a> to turn the LED on pin 5 off.<br>");
        ...
        if (currentLine.endsWith("GET /C-H")) {
          digitalWrite(5, HIGH);
          SerialPort.println("1");               // GET /H turns the LED on
          
        }
        if (currentLine.endsWith("GET /A-H")) {
          digitalWrite(5, LOW);  
